					...
					<form onSubmit={handleLogin} className="space-y-5">
						...
						<div className="space-y-3 pt-1">
							...
							<button
								...
								disabled={isLoading}
								className="w-full h-12 bg-white dark:bg-transparent border-2 border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 text-[#3c4043] dark:text-[#e2e2e6] flex items-center justify-center gap-4 transition-all rounded-none text-[10px] font-black uppercase tracking-widest shadow-sm"
							>
