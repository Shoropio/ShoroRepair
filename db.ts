...
export class RepairDB extends Dexie {
  ...
  constructor() {
    ...
    this.version(7).stores({
      ...
      orders: '++id, syncId, orderNumber, clientId, status, deviceType, createdAt, technicianId, paymentStatus, updatedAt, synced, deleted',
      ...
      // Upgrade logic for existing records
    ...
    // Add hooks for automatic sync management
